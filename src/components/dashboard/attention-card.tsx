  ...
  return (
    <div className="relative flex h-full w-[280px] shrink-0 snap-start flex-col overflow-hidden rounded-xl border border-black/5 bg-white shadow-sm sm:w-[300px] lg:w-auto lg:shrink">
      ...
      <div className="flex flex-1 flex-col gap-3 p-5 pl-6">
        <div className="flex flex-wrap items-start justify-between gap-2">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="font-medium leading-tight text-[#1b1626]">
                {card.name}
              </p>
        ...
        {(card.meta || cta) && (
          <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-2 border-t border-black/5 pt-4">
            {card.meta ? (
